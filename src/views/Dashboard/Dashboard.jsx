...
import CustomSkinMap from "views/Maps/Maps.jsx";
          ...
          <GridItem xs={12} sm={12} md={6}>
            ...
            <Card>
              <CardHeader color="info">
                <h4 className={classes.cardTitleWhite}>Active Washers</h4>
                <p className={classes.cardCategoryWhite}>
                  There are currently 3 active washers.
                </p>
              </CardHeader>
            ...
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Active Drivers</h4>
                <p className={classes.cardCategoryWhite}>
                  There are currently 2 active drivers.
                </p>
              </CardHeader>
              <CardBody>
                <Table
